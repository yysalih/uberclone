...
class SelectAddressOnMapPage extends StatefulWidget {
  const SelectAddressOnMapPage({Key? key, required this.addressUid}) : super(key: key);
...
class _SelectAddressOnMapPageState extends State<SelectAddressOnMapPage> {
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text("$fullAddress", style: TextStyle(fontSize: 20, fontFamily: kFontFamily),
  ...
  _addMarker(LatLng pos) async { //origin == null || (origin != null && destination != null)
    ...
    setState(() {
      info = directions;
      distance = double.parse((Geolocator.distanceBetween(destination.position.latitude,
