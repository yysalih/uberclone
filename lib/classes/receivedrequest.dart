...
class ReceivedRequest extends Equatable {
  ...
  ReceivedRequest({ required this.destinationFullAddress, required this.distance,
  ...
  static ReceivedRequest fromSnapshot(DocumentSnapshot snapshot) {
    ReceivedRequest sentRequest = ReceivedRequest(
  ...
  Map<String, Object> toDocument() {
    return {
      ...
      "placeToGo" : placeToGo, "point" : point,
      "status" : status, "to" : to, "bookednow" : bookednow, "money" : money
    };
  }
