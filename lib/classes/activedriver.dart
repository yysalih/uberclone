...
class ActiveDrive extends Equatable {
  ...
  ActiveDrive({ required this.destinationFullAddress, required this.distance,
    required this.drive_uid, required this.driver_uid, required this.date,
    required this.hasfinished, required this.hasmet,
    required this.from, required this.note, required this.passenger_uid,
  ...
  List<Object?> get props => [
    ...
    note, passenger_uid, placeToGo, point, status, to,bookednow, money
  ];

  static ActiveDrive fromSnapshot(DocumentSnapshot snapshot) {
    ActiveDrive sentRequest = ActiveDrive(
      ...
      from: snapshot["from"], note: snapshot["note"], passenger_uid: snapshot["passenger_uid"], placeToGo: snapshot["placeToGo"],
  ...
  Map<String, Object> toDocument() {
    return {
      ...
      "from" : from, "note" : note, "passenger_uid" : passenger_uid,
